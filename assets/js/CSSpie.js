function createPie(pieName,pieSize,baseColor,numberOfSlices,percentages,colors,text){
	...
	// Inner circle
	var innerSize = (sizeNum-10) + "px";
	var innerCircle = document.createElement("div");
	innerCircle.className = "inner_circle";
	innerCircle.textContent = text;
	innerCircle.style.width=innerSize;
	innerCircle.style.height=innerSize;
	innerCircle.style.position="absolute";
	innerCircle.style.webkitBorderRadius=innerSize;
	innerCircle.style.mozBorderRadius=innerSize;
	innerCircle.style.borderRadius=innerSize;
	innerCircle.style.backgroundColor=baseColor;
	innerCircle.style.top= 5 + "px";
	innerCircle.style.left = 5 +"px";
	innerCircle.style.fontSize = "200%";
	innerCircle.style.textAlign = "center";
	innerCircle.style.lineHeight = innerSize;
	pieBackground.appendChild(innerCircle);
